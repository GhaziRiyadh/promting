    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <div>
                    <h2 className="text-xl font-semibold tracking-tight">AI Models Configuration</h2>
                    <p className="text-sm text-muted-foreground">Manage available AI models for users.</p>
                </div>
